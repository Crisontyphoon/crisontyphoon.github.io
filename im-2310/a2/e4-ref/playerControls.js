...
let media = document.getElementById("videoElement")
...
muteButton.addEventListener("click", muteUmute)
...
/* Forward/Rewind */
/*The forward and rewind buttons fast forwards the video or rewinds the video*/
/*this function is good as it allows the user to seek forward to skim the video,
or 
allow go back easier to repeat a section.*/

const fwdButton = document.getElementById("fwdButton");
const rwdButton = document.getElementById("rwdButton");

/*rewind and fastforward by 5 seconds*/
...
/* Adding a keybind to the fastforward, rewind function and pause function since other platforms like youtube also has the same function.
So users who interact with video may also use the same keybinds to attempt to fastforward the video.*/
/*this is added more so for familiarity, where a user would be used to other functions from bigger sites.*/
